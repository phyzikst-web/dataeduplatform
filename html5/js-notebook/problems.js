window.JS_PROBLEMS = [
  {
    ...
    "answerCode": "let myName  = '홍길동';\nlet myAge   = 20;\nlet isAdult = myAge >= 19;\n\nconsole.log('이름:', myName);\nconsole.log('나이:', myAge);\nconsole.log('성인 여부:', isAdult);"
  },
  {
    "id": "lab02_arithmetic",
  ...
  },
  {
    ...
    "answerCode": "let scores = [85, 92, 78, 96, 60];\nlet total  = 0;\n\nfor (let i = 0; i < scores.length; i++) {\n    total += scores[i];\n}\n\nlet average = total / scores.length;\n\nconsole.log('점수 목록:', scores.join(' '));\nconsole.log('합계:', total);\nconsole.log('평균:', average);"
  },
  {
    "id": "lab08_func_max",
    ...
    "answerCode": "let numbers = [3, 7, 2, 9, 5, 1, 8];\n\nfunction findMax(arr) {\n    let max = arr[0];\n    for (let i = 1; i < arr.length; i++) {\n        if (arr[i] > max) {\n            max = arr[i];\n        }\n    }\n    return max;\n}\n\nconsole.log('배열:', numbers.join(' '));\nconsole.log('최댓값:', findMax(numbers));"
  },
  {
    "id": "lab09_func_even",
    ...
    "answerCode": "function checkEvenOdd(n) {\n    if (n % 2 === 0) { return '짝수'; }\n    else             { return '홀수'; }\n}\n\nfor (let i = 1; i <= 10; i++) {\n    console.log(i + ' → ' + checkEvenOdd(i));\n}"
  },
  {
    ...
    "answerCode": "let scores = [12, 45, 88, 30, 67, 55, 9, 71];\n\nfunction myFilter(arr, callback) {\n    let filtered = [];\n    for (let i = 0; i < arr.length; i++) {\n        if (callback(arr[i])) {\n            filtered.push(arr[i]);\n        }\n    }\n    return filtered;\n}\n\nlet over50 = myFilter(scores, function(n) {\n    return n >= 50;\n});\n\nlet odds = myFilter(scores, function(n) {\n    return n % 2 !== 0;\n});\n\nconsole.log('원본:', scores.join(' '));\nconsole.log('50 이상:', over50.join(' '));\nconsole.log('홀수:', odds.join(' '));"
  },
  {
  ...
  },
  {
    ...
    "code": "for (          ) {\n    console.log('===', dan + '단', '===');\n    for (          ) {\n\n    }\n    console.log('');\n}",
    "answerCode": "for (let dan = 2; dan <= 9; dan++) {\n    console.log('===', dan + '단', '===');\n    for (let i = 1; i <= 9; i++) {\n        console.log(dan + ' x ' + i + ' = ' + (dan * i));\n    }\n    console.log('');\n}"
  },
  {
  ...
  },
  {
    ...
    "answerCode": "function fibonacci(n) {\n    let fib = [1, 1];\n    for (let i = 2; i < n; i++) {\n        fib.push(fib[i - 1] + fib[i - 2]);\n    }\n    return fib;\n}\n\nconsole.log('피보나치 10개:', fibonacci(10).join(' '));\nconsole.log('피보나치 5개: ', fibonacci(5).join(' '));"
  },
  {
    "id": "lab20_final",
